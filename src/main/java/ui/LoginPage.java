...
public class LoginPage {
    ...
    public WebElement getLoginButton(){
        return helper.waitToBeClickable(driver.findElement(By.xpath("//ul//a[@href='/login']")));
    }

    public String getHomePageHeader (){
        return driver.findElement(By.xpath("//h1[contains(text(),'QA Sandbox')]")).getText();
    }
    ...
    public WebElement getPasswordInputField(){
        return helper.waitToBeClickable(driver.findElement(By.name("password")));
    }
    ...
    public WebElement getSubmitButton(){
        return helper.waitToBeClickable(driver.findElement(By.xpath("//button[@type='submit']")));
    }
